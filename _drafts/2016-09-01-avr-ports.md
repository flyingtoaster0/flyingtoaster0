...
First we set up our hardware by setting pin 13 to output mode; then we go into the loop, set pin 13 to high - turning the LED on, wait 1000ms, set pin 13 to low - turning the LED off, wait 1000ms, then loop forever. Simple!
